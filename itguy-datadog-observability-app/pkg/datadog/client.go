...
func (c *Client) QueryMetrics(ctx context.Context, query string, from int64, to int64) (*MetricsQueryResponse, error) {
	params := url.Values{}
	...
	if err := c.getJSON(ctx, "/query", params, &response); err != nil {
		return nil, err
	}
