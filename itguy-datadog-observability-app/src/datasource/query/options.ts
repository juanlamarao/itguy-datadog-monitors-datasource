...
export const queryTypeOptions: Array<SelectableValue<DatadogQueryType>> = [
  { label: 'Monitors', value: 'monitor', description: 'Consulta /monitor/search' },
  { label: 'Monitor groups', value: 'group_monitor', description: 'Consulta /monitor/groups/search' },
  { label: 'All monitors', value: 'all', description: 'Consulta monitors + monitor groups' },
  { label: 'Metrics', value: 'metric', description: 'Consulta timeseries via /query' },
];

export const monitorOutputFormatOptions: Array<SelectableValue<DatadogOutputFormat>> = [
  { label: 'Table fields', value: 'table' },
  { label: 'Problems object', value: 'problems' },
];

export const metricOutputFormatOptions: Array<SelectableValue<DatadogOutputFormat>> = [
  { label: 'Time series', value: 'timeseries' },
  { label: 'Table points', value: 'table' },
];

export const outputFormatOptions = monitorOutputFormatOptions;
...
export function fromSelectableValues(values: Array<SelectableValue<string>> | readonly SelectableValue<string>[]): string[] {
  return values
    .map((item) => item.value)
